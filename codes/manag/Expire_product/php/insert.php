...
if(!empty($_POST))
{
        ...
        $sum ="SELECT max(exp_id) as id FROM tb_expire_product ";
        ...
        $sql="INSERT INTO `tb_expire_product`(`exp_id`, `exp_date`, `emp_id`)
        VALUES ('".$data_id."', '".date("Y/m/d H:i:s")."', '".$_SESSION['user_id']."')";
        ...
        $query ="INSERT INTO `tb_expire_product_detail`(`exp_id`, `pro_barcode`, `quality`, `price`, `total`) 

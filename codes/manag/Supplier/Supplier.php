        ...
        <div class="content p-4">
            ...
            <div class="card mb-4">
                <div class="card-header bg-white font-weight-bold">        
                    ...
                    <h4>ຂໍ້ມູນຜູ້ສະໜອງ</h4>
                    
                    
                </div>
                <div class="card-body">
                <div align="right">   
                    <button type="button" class="btn btn-success" title="ເພີ້ມ" name="add" id="add" >ເພີ້ມຂໍ້ມູນຜູ້ສະໜອງ</button>
...
<script>
        $(document).ready(function () {
            ...
            $('#add').click(function () {
                ...
                $('#insert').val("ເພີ້ມຂໍ້ມູນຜູ້ສະໜອງ");
                $('#insert_form')[0].reset();
                $('#status').val('Insert');
            ...
            $(document).on('click', '.edit_data', function(){  
                ...
                $.ajax({  
                    ...
                    success:function(data){  
                        ...
                        $('#phone').val(data.sup_phone); 
                        $('#Address').val(data.sup_address); 
                      

                        $('#employee_id').val(data.sup_id);  
                       
                       
                        $('#add_data_Modal').modal('show');
                        $('#insert').val("ແກ້ໄຂຂໍ້ມູນຜູ້ສະໜອງ");
                        $('#status').val('Update');  
                    }  
                });  
            });

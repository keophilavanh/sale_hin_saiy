    ...
    ?>
        ...
        <div class="content p-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                <div align="right">   
                    <button type="button" class="btn btn-success" title="ເພີ້ມ" name="add" id="add" >ເພີ້ມຂໍ້ມູນຫົວໜ່ວຍສິນຄ້າ</button>
            ...
            $(document).on('click', '.edit_data', function(){  
                ...
                $.ajax({  
                    ...
                    success:function(data){  
                        ...
                        $('#UnitName').val(data.uni_name);  
                        $('#employee_id').val(data.uni_id);  
                       
                       
                        $('#add_data_Modal').modal('show');
                        $('#insert').val("ແກ້ໄຂຂໍ້ມູນຫົວໜ່ວຍສິນຄ້າ");
                        $('#status').val('Update');  
                    }  
                });  
            });

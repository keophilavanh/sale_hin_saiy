        ...
        <div class="content p-4">
            ...
            <div class="card mb-4">
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-primary btn-lg Cash">ແກ້ໄຂ</button>
                    </td>
                </tr> 
                </table>
                        ...
                        if (willDelete) {
                            ...
                            icon: "success",
                                ...
                                $.ajax({
                                    url:"php/update.php",
                                    method:"POST",
                                    data:{item_code:item_code,item_name:item_name,item_qty:item_qty,item_price:item_price,item_total_price,supplier_id:supplier_id,id_url:id_url},
                                    datatype:"text",
                                    success:function(data){
